import { Button as TButton, Image, Sheet, Text, useTheme, View, XStack, YStack } from "tamagui";
import { Check, Edit, FileCheck, Truck, User } from "lucide-react-native"
        ...
        <>
            ...
            >
                ...
                <Sheet.Frame padding="20" >
                    <YStack gap="$5">
                        <Button label="Clientes" Icon={User} color={theme.main?.val} />
                        <Button label="Materiais" Icon={Truck} color={theme.main?.val} />
